...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "XML reporting", "Story\n=====\nIn order to get testresults in XML format\nAs a developer\nI want to le" +
                    "arn about [SpecResults.Xml](https://www.nuget.org/packages/SpecResults.Xml/)", ProgrammingLanguage.CSharp, new string[] {
                        "Plugin",
                        "Plugin"});
        ...
        public virtual void LearnHowToInstallTheSpecResults_XmlPackage()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Learn how to install the SpecResults.Xml package", new string[] {
                        "Howto:install"});
#line 10
...
#line 12
 testRunner.When("I enter searchtext \"SpecResults.Xml\" in \"searchBoxInput\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 13
 testRunner.And("I click the search button \"searchBoxSubmit\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 14
 testRunner.And("I click the result with title \"SpecResults.Xml\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 15

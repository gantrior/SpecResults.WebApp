...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Plain Text reporting", "Story\n=====\nIn order to get testresults in plain text format\nAs a developer\nI wan" +
                    "t to learn about [SpecResults.PlainText](https://www.nuget.org/packages/SpecResu" +
                    "lts.PlainText/)", ProgrammingLanguage.CSharp, new string[] {
                        "Plugin",
                        "Plugin"});
        ...
        public virtual void LearnHowToInstallTheSpecResults_PlainTextPackage()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Learn how to install the SpecResults.PlainText package", new string[] {
                        "Howto:install"});
#line 10
...
#line 12
 testRunner.When("I enter searchtext \"SpecResults.PlainText\" in \"searchBoxInput\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 13
 testRunner.And("I click the search button \"searchBoxSubmit\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 14
 testRunner.And("I click the result with title \"SpecResults.PlainText\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 15

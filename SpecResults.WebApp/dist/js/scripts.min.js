...
(function(window, document, undefined) {
    ...
    function minErr(module) {
        return function() {
            ...
            message = message + "\nhttp://errors.angularjs.org/1.2.29/" + (module ? module + "/" : "") + code;
        ...
        function Report(reportData) {
            ...
            this.searchIndex = _.map(this.scenarios, function(scenario) {
                ...
                return {
                    ...
                    steps: _.union(scenario.given.steps, scenario.when.steps, scenario.then.steps)
                };
            }, this);
        }
